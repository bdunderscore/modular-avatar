...
### Fixed
- [#2100] Fixed mesh distortion when NaNimation is applied to a body and outfit with different scales.
...
### Fixed
- [#2068] Blendshape curves would be set incorrectly when migrating from prior versions of MA.
