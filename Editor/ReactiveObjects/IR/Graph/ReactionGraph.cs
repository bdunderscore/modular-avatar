...
namespace nadena.dev.modular_avatar.core.editor.rc.Graph
{
    public class ReactionGraph
    {
        ...
        public void ForwardObjectActiveDrivers()
        {
            ...
            static List<ObjectActiveState> FindAllObjectActiveStates(IExpression expr)
            {
            ...
            static IExpression BuildReplacementForTwoOrFewer(List<(IExpression nodeExpr, bool aligns)> aligns)
            {
                if (aligns.Count == 1)
                {
            ...
            static IExpression ReplaceObjectActiveState(IExpression expr, ObjectActiveState target,
            ...
            static bool SameTarget(ObjectActiveState a, ObjectActiveState b)
            {
