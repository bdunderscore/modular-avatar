...
namespace nadena.dev.modular_avatar.core.editor
{
    ...
    internal static class ParameterIntrospectionCache
    {
        ...
        internal static PropCache<GameObject, ImmutableDictionary<(ParameterNamespace, string), ParameterMapping>> ParameterRemappingCache = new (GetRemappingsForAvatar);
        
        private static ImmutableList<ProvidedParameter> GetParametersForObject_miss(ComputeContext ctx, GameObject avatar)
        {
            return ParameterInfo.ForPreview(ctx).GetParametersForObject(avatar).ToImmutableList();
        }
        
        private static ImmutableDictionary<(ParameterNamespace, string), ParameterMapping> GetParameterRemappingsAt_miss(ComputeContext ctx, GameObject avatar)
        {
            return ParameterInfo.ForPreview(ctx).GetParameterRemappingsAt(avatar);
        }
