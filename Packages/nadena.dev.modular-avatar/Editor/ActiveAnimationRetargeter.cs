...
namespace nadena.dev.modular_avatar.core.editor
{
    ...
    internal class ActiveAnimationRetargeter
    {
        ...
        public ActiveAnimationRetargeter(BuildContext context, Transform root)
        {
            _context = context;
        ...
        public GameObject CreateIntermediateObjects(GameObject sourceBone)
        {
            for (var i = 0; i < _intermediateObjs.Count; i++)
            {
                ...
                BoneDatabase.AddMergedBone(sourceBone.transform);
                BoneDatabase.RetainMergedBone(sourceBone.transform);
                PathMappings.MarkTransformLookthrough(sourceBone);
            }
